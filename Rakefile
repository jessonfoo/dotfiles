require 'rake'
require 'fileutils'
require File.join(File.dirname(__FILE__), 'bin', 'gzn', 'vundle')

desc "Hook our dotfiles into system-standard positions."
task :install => [:submodule_init, :submodules] do
  puts
  puts "======================================================"
  puts "Installing Dotfiles from Jesson's DotFiles."
  puts "======================================================"
  puts
...
task :submodules do
  unless ENV["SKIP_SUBMODULES"]
    puts "======================================================"
    puts "Downloading gzn submodules...please wait"
    puts "======================================================"
...
def install_fonts
  ...
  puts "======================================================"
  run %{ cp -f $HOME/.gzn/fonts/* $HOME/Library/Fonts } if RUBY_PLATFORM.downcase.include?("darwin")
  run %{ mkdir -p ~/.fonts && cp ~/.gzn/fonts/* ~/.fonts && fc-cache -vf ~/.fonts } if RUBY_PLATFORM.downcase.include?("linux")
  puts
end
...
def install_prezto
  ...
  run %{ ln -nfs "$HOME/.gzn/zsh/prezto-override/zpreztorc" "${ZDOTDIR:-$HOME}/.zpreztorc" }
